...
<div class="popup-overlay">
	<div class="popup-salon">
		...
		// (Ajout de 'echo' pour afficher le formulaire)
...
*/
// Nouveau script 
function closePopup() { // Fonction pour fermer la popup
	jQuery('.popup-overlay').fadeOut().animate({
		display: 'none'
	}, 1000);
}
jQuery('.popup-close').click(function(){ // EventListener pour fermer la popup au click sur popup-close
	closePopup();
})
</script>
